    ...
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          console.warn(`Module "node:stream/web" has been externalized for browser compatibility. Cannot access "node:stream/web.${key}" in client code. See https://vitejs.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
        }
      }
    }));
  }
...
var require_streams = __commonJS({
  "node_modules/fetch-blob/streams.cjs"() {
    ...
    if (!globalThis.ReadableStream) {
      try {
        const process = require_node_process();
        const { emitWarning } = process;
        try {
          process.emitWarning = () => {
          };
          Object.assign(globalThis, require_web());
    ...
    try {
      const { Blob: Blob2 } = require_buffer();
...
var require_node_domexception = __commonJS({
  "node_modules/node-domexception/index.js"(exports, module) {
    if (!globalThis.DOMException) {
      try {
        const { MessageChannel } = require_worker_threads(), port = new MessageChannel().port1, ab = new ArrayBuffer();
...
var import_node_domexception = __toESM(require_node_domexception());
var { stat } = import_node_fs.promises;
var blobFromSync = (path, type) => fromBlob((0, import_node_fs.statSync)(path), path, type);
...
var fileFromSync = (path, type) => fromFile((0, import_node_fs.statSync)(path), path, type);
...
*/
//# sourceMappingURL=chunk-7A2AK6LQ.js.map
