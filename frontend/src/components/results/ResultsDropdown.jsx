...
const ResultsDropdown = ({ id, selectedGame, setSelectedGame }) => {
  ...
  return (
    <>
      <div className="flex flex-col justify-end bg-[#42424a] px-3 py-2 rounded-tr-md rounded-br-md cursor-pointer hover:bg-zinc-800 transition duration-300 select-none" onClick={handleClick}>
