...
const SignIn = () => {
  ...
  if (!user) {
    return (
      <a
        id="login"
        href={`https://discord.com/oauth2/authorize?client_id=1111800916589432906&response_type=token&redirect_uri=http%3A%2F%2F${import.meta.env.VITE_BASE_URL}&scope=identify`}
