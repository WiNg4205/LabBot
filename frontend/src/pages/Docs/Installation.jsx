...
const Installation = () => {
  ...
  return (
    <div className={`flex w-full justify-center h-screen bg-zinc-900 text-zinc-300`}>
      ...
      <main className={`flex-col p-8 mt-4 overflow-y-auto w-full lg:w-[54rem] [@media(min-width:1500px)]:w-[70rem] [@media(min-width:1900px)]:w-[90rem] ${isOpen ? "opacity-60 pointer-events-none" : ""}`}>
